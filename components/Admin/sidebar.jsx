...
// Log translation key and translated string for "dashboard"
console.log('Translation key for "dashboard":', 'dashboard');
console.log('Translated string for "dashboard":', t('dashboard'));
